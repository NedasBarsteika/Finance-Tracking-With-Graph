...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            print("No transactions found in data range")
        else:
...
def add():
    CSV.initialize_csv()
    date = get_date("Enter the date of the transaction (yyyy-mm-dd) or press Enter for today's date: ", allow_default=True)
    amount = get_amount()
